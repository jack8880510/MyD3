...
namespace MyD3.Entity.DBEntity
{
    ...
    /// 系统配置类
    /// </summary>
    public class SystemSetting : MyD3Entity
    {
        public SystemSetting() { }

        public SystemSetting(SystemSettingDetail detail)
        {
            this.CreateDate = detail.CreateDate;
            this.CreatorID = detail.CreatorID;
            this.Description = detail.Description;
            this.DisplayName = detail.DisplayName;
            this.GroupID = detail.GroupID;
            this.ID = detail.ID;
            this.MaxLength = detail.MaxLength;
            this.MinLength = detail.MinLength;
            this.ModifyDate = detail.ModifyDate;
            this.ModifyUser = detail.ModifyUser;
            this.Name = detail.Name;
            this.OptionText = detail.OptionText;
            this.OptionType = detail.OptionType;
            this.OptionValue = detail.OptionValue;
            this.OrderNo = detail.OrderNo;
            this.Required = detail.Required;
            this.Status = detail.Status;
            this.TextReg = detail.TextReg;
