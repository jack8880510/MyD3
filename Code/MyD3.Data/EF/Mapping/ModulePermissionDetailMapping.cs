...
{
    class ModulePermissionDetailMapping : EntityTypeConfiguration<ModulePermissionDetail>
    {
        public ModulePermissionDetailMapping()
        {
            this.ToTable("ModulPermissionDetail");
            this.HasKey(x => x.ID);
